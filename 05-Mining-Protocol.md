...
| coinbase_prefix             | B0_255         | To be placed at the beginning of the scriptSig field in the coinbase transaction. Its length plus the full Extended Extranonce size of the channel (or of the channels in the group) MUST NOT exceed the 100-byte consensus limit on the coinbase scriptSig.                              |
