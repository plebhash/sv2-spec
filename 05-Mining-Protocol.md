...
| coinbase_prefix             | B0_255         | To be placed at the beginning of the scriptSig field in the coinbase transaction. The sender MUST NOT send a `coinbase_prefix` longer than 8 bytes, excluding the `B0_255` length prefix.                              |
