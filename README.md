...
This repository contains the Stratum V2 protocol specification.
 ...
 - [7. Template Distribution Protocol](./07-Template-Distribution-Protocol.md#7-template-distribution-protocol)
  - [7.1. `SetupConnection` Flags for Template Distribution Protocol](./07-Template-Distribution-Protocol.md#71-setupconnection-flags-for-template-distribution-protocol)
  - [7.2. `CoinbaseOutputConstraints` (Client -> Server)](./07-Template-Distribution-Protocol.md#72-coinbaseoutputconstraints-client---server)
  - [7.3. `NewTemplate` (Server -> Client)](./07-Template-Distribution-Protocol.md#73-newtemplate-server---client)
  - [7.4. `SetNewPrevHash` (Server -> Client)](./07-Template-Distribution-Protocol.md#74-setnewprevhash-server---client)
  - [7.5. `RequestTransactionData` (Client -> Server)](./07-Template-Distribution-Protocol.md#75-requesttransactiondata-client---server)
  - [7.6. `RequestTransactionData.Success` (Server->Client)](./07-Template-Distribution-Protocol.md#76-requesttransactiondatasuccess-server-client)
  - [7.7. `RequestTransactionData.Error` (Server->Client)](./07-Template-Distribution-Protocol.md#77-requesttransactiondataerror-server-client)
  - [7.8. `SubmitSolution` (Client -> Server)](./07-Template-Distribution-Protocol.md#78-submitsolution-client---server)
